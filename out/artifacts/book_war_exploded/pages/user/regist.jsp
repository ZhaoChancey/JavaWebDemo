...
<script>
	...
	$(function () {
		...
		$("#code_img").click(function () {
			// 给验证码的图片绑定单击事件
			// 在事件响应的function函数中有一个this对象。这个this对象，是当前正在响应事件的dom对象，this就表示<img>这个标签
...
<%--										   value="<%=request.getAttribute("email")==null?"":request.getAttribute("email")%>"--%>
									...
									<img alt="" id="code_img" src="kaptcha.jpg" style="float: right; margin-right: 40px;width: 110px;height: 38px">
									<br />
									<br />
